...
<nav class="navbar navbar-expand-md navbar-dark bg-dark">
    <div class="container">
        <a class="navbar-brand" href="home">Mavie Shop</a>
...
<section class="jumbotron text-center">
    <div class="container">
        <h1 class="jumbotron-heading">Mavie Shop</h1>
        <p class="lead text-muted mb-0">Cửa hàng điện thoại và thiết bị điện tử</p>
    </div>
</section>
<!--end of menu-->
